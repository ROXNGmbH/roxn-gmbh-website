...
@section('page-title','Edit Manufacturing Company')

@section('content-header')
    <div class="content-header d-flex justify-content-between" style="width:100%">
        <div>
            <h2 class="content-title card-title">Edit Manufacturing Company</h2>
        </div>
    </div>
@stop

@section('main-content')
    <form action="{{route('manufacturing-companies.update',$manufacturingCompany->id)}}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="input-upload">
                            <img src="{{$manufacturingCompany->image}}" width="200" height="100" alt="" id="image">
