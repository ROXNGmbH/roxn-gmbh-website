            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <input type="text" name="name_de" id="name_de" class="form-control" placeholder="Enter product name de"><br>
                    </div>
                    <div class="col-lg-6">
                        <label for="name_ar" class="mb-2">Name (ar)</label>
                        <input type="text" name="name_ar" id="name_ar" class="form-control" placeholder="Enter product name ar"><br>
                    </div>
                </div>
                <div class="row">
