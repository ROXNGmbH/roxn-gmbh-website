            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <input type="text" name="name_de" id="name_de" value="{{$product->name_de}}" class="form-control"
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-4">
                        ...
                        <select name="sell_type_id" id="sell_type_id" class="form-control search-form">
                            ...
                            @foreach($sell_types as $sell_type)
                                <option
                                    value="{{$sell_type->id}}" @if($product->sell_type_id == $sell_type->id) selected @endif>{{$sell_type->name_ar . ' - ' . $sell_type->name_de}}</option>
                            @endforeach
                        </select>
                        @error('sell_type_id')
                        <p class="text-danger">{{$message}}</p>
                    ...
                    <div class="col-4">
                        ...
                        <select name="flag_id" id="flag_id" class="form-control search-form">
                            ...
                            @foreach($flags as $flag)
                                <option value="{{$flag->id}}" @if($product->flag_id == $flag->id) selected @endif>{{$flag->name_ar . ' - ' . $flag->name_de}}</option>
                            @endforeach
                        </select>
                        @error('flag_id')
                        <p class="text-danger">{{$message}}</p>
                    ...
                    <div class="col-4">
                        ...
                        <select name="unit_id" id="unit_id" class="form-control search-form">
                            ...
                            @foreach($unit as $value)
                                <option value="{{$value->id}}" @if($product->unit_id == $value->id) selected @endif>{{$value->name}}</option>
                            @endforeach
                        </select>
                        @error('unit_id')
                        <p class="text-danger">{{$message}}</p>
                    ...
                    <div class="col-4">
                        ...
                        <select name="category_id" id="category_id" class="form-control search-form">
                            ...
                            @foreach($categories as $category)
                                <option value="{{$category->id}}" @if($product->category_id == $category->id) selected @endif>{{$category->name_ar}}</option>
                            @endforeach
                        </select>
                        @error('category_id')
                        <p class="text-danger">{{$message}}</p>
                    ...
                    <div class="col-4">
                        ...
                        <input type="checkbox"  @if($product->bro_product) checked @endif name="bro_product" id="bro_product">
                    </div>
