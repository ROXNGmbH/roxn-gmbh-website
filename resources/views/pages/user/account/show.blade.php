                                                        ...
                                                        <form method="post" name="enq">
                                                            <div class="row">
                                                                <div class="form-group col-md-12">
                                                                    <label>Department Number and street<span class="required">*</span></label>
                                                                    <input required="" class="form-control" name="name" type="text" />
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label>Zip Code<span class="required">*</span></label>
                                                                    <input required="" class="form-control" name="Zip Code" type="text" />
                                                                </div>
                                                                <div class="form-group col-md-12">
                                        ...
                                        <div class="card-body">
                                            <form method="post" name="enq">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label>Converse <span class="required">*</span></label>
                                                        <input required="" class="form-control" name="converse" type="text" />
                                                    </div>
                                                    <div class="form-group col-md-6">
